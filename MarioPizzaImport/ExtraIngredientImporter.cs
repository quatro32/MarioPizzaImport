...
{
    class ExtraIngredientImporter: Importer<ingredient>
    {
        public ExtraIngredientImporter(dbi298845_prangersEntities database, countrycode countrycode) : base(database, countrycode) { }
